...
class CommentWidget extends StatelessWidget {
  ...
  _commentOnDelete(BuildContext context, String res) async {
    print('deleting ......................');
    ...
    if (res != null && commentStateProvider.replyIdToBeDeleted == null) {
    ...
    final String message = res == null ? 'failed to delete ${commentStateProvider.replyIdToBeDeleted != null ? 'reply' : 'comment'}' : res;
    print(message);
                                  ...
                                  onDelete: () async {
                                    ...
                                    if (commentStateProvider.insideRepliesPage && !mainComment) {
                                      ...
                                      commentStateProvider
                                          ...
                                          .then((value) => _commentOnDelete(context,value));
                                    } else {
