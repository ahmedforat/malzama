...
class SchoolMaterialDescriptionWidget<T extends MaterialStateRepo> extends StatefulWidget {
  final int pos;
...
class __DescriptionWidgetState<B extends MaterialStateRepo> extends State<SchoolMaterialDescriptionWidget> {
  bool _isBroken;
