...
class UniversityTeacher extends StatefulWidget {
  @override
  _UniversityTeacherState createState() => _UniversityTeacherState();
}

class _UniversityTeacherState extends State<UniversityTeacher> {
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Expanded(child: DropdownButtonHideUnderline(child: ButtonTheme(
                              ...
                              child: DropdownButton<String>(
                                isDense: true,
                                hint: new Text("Teaching material"),
                                value: _mySelection3,
                                onChanged: (String newValue){
                                  setState(() {
