...
class _AuthThreePageState extends State<AuthThreePage> {
  final String backImg = 'assets/12.jpg';
  bool formVisible;
  int _formsIndex;
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    OutlineButton.icon(
                      borderSide: BorderSide(color: Color(0xfff29a94)),
                      color: Color(0xfff29a94),
                      textColor: Colors.white,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20.0),
                        ...
                        children: <Widget>[
                          RaisedButton(
                            textColor: _formsIndex == 1
                                ...
                                : Colors.black,
                            color:
                            _formsIndex == 1 ? Color(0xff696b9e) : Colors.white,
                            child: Text("Login"),
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(20.0)),
                            onPressed: () {
                          ...
                          RaisedButton(
                            textColor: _formsIndex == 2
                                ...
                                : Colors.black,
                            color:
                            _formsIndex == 2 ? Color(0xff696b9e) : Colors.white,
                            child: Text("Signup"),
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(20.0)),
                            onPressed: () {
